...
<?php requireAuth(["admin", "secretary"]); ?>
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "create" || $action === "update") {
        ...
        if (!$fn || !$ln) {
            ...
            header('Location: ' . $_SERVER['REQUEST_URI']);
            exit;
        } elseif (($_POST["monthly_household_income"] ?? "") && !is_numeric($_POST["monthly_household_income"])) {
            ...
            $mhi = $_POST["monthly_household_income"] ? (float)$_POST["monthly_household_income"] : null;
